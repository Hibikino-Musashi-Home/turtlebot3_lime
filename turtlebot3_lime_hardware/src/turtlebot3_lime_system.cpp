...
#include "turtlebot3_lime_hardware/turtlebot3_lime_system.hpp"
...
hardware_interface::CallbackReturn TurtleBot3LimeSystemHardware::on_deactivate(
    const rclcpp_lifecycle::State& /*previous_state*/) {
...
hardware_interface::return_type TurtleBot3LimeSystemHardware::read(
...
hardware_interface::return_type TurtleBot3LimeSystemHardware::write(
    const rclcpp::Time& /*time*/, const rclcpp::Duration& /*period*/) {
...
PLUGINLIB_EXPORT_CLASS(
    robotis::turtlebot3_lime_hardware::TurtleBot3LimeSystemHardware,
